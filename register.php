...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO form(firstname, secondname, email, phone, dateofbirth, nationality,gender, transport, vehicle, border, cv) 
              VALUES ('$fname', '$lname', '$email', '$phone','$dob', '$nationality','$gender', '$transport', '$vehicle', '$border', '$cv')";
...
<a href="#">about</a>
<a href="company.html">services</a>
...
<input type="file" name="cv"><div class="bu">
            ...
            <input type="submit" name="resert" value="resert" ></div>
    </form></center>
  </section>
  <br><br><br><br>
  <footer class="footer">
